...
public class VideoFocusManager {
    ...
    private static final String TAG = "CAM_VideoFocusManager";
    ...
    public VideoFocusManager(Parameters parameters,Listener listener,FocusUI ui,boolean mirror) {
    ...
    public void setParameters(Parameters parameters) {
        ...
        // camera is open.
    	Log.d(TAG,"-----VideoFocusManager init---");
